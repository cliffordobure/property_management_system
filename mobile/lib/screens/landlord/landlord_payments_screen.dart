      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('No payments', style: Theme.of(context).textTheme.titleMedium?.copyWith(color: AppTheme.onSurfaceVariant)),
        ...
        itemBuilder: (context, i) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              subtitle: Text('$date · $method${tenantName != null ? ' · $tenantName' : ''}'),
              leading: CircleAvatar(backgroundColor: Colors.green.withValues(alpha: 0.2), child: const Icon(Icons.payment, color: Colors.green)),
            ),
          );
        },
      ),
